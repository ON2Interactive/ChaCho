...
function ShareIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M14 4H20V10" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M20 4L11 13" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path
        d="M18 13V17C18 18.1046 17.1046 19 16 19H7C5.89543 19 5 18.1046 5 17V8C5 6.89543 5.89543 6 7 6H11"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function CodeIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path d="M13 6L11 18" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
