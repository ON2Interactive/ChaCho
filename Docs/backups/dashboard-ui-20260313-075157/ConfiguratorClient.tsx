...
function PaperPlaneIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M20.92 3.62C21.23 3.74 21.44 4.04 21.45 4.37C21.47 4.7 21.28 5.01 20.98 5.17L7.64 12.2L20.98 18.83C21.28 18.98 21.47 19.3 21.45 19.62C21.44 19.96 21.23 20.26 20.92 20.38C20.83 20.42 20.73 20.44 20.63 20.44C20.41 20.44 20.19 20.36 20.02 20.21L3.48 13.58C3.14 13.44 2.92 13.11 2.92 12.74C2.92 12.37 3.14 12.04 3.48 11.9L20.02 3.79C20.27 3.6 20.62 3.52 20.92 3.62Z" />
    </svg>
  );
}
